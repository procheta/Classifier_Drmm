...
if len(sys.argv) < 10:
    print('Needs 5 arguments - 1. run name, 2. train pair file (fold), 3. train histogram file,4. left query roberta vector , 5. right query roberta vector 6. test file (fold), 7. test histogram file 8.left query roberta vector 9. right query roberta vector')
    exit(0)
